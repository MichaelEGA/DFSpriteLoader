...
{
    private string spriteFolderPath = "Assets/Data/CharacterTextures/DefaultTrooper";
    private string savePath = "Assets/Data/Animations/DefaultTrooper";
    ...
    public void LinkStates()
    {
        ...
        AssetDatabase.SaveAssets();
        Debug.Log("Successfully linked Animator states to Idle!");
    }
