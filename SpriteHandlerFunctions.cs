...
public static class SpriteHandlerFunctions
{
    ...
    public static void SetRotation(SpriteHandler spriteRotation)
    {
        ...
        if (selectedAnimation != "isDyingv1" & selectedAnimation != "isDyingv2" & selectedAnimation != "isDeadCorpse")
        {
            if (angle > -22.5f && angle < 22.6f) //front
            {
            ...
            else if (angle >= 22.5f && angle < 67.5f)  //front angle right
            {
                animator.SetLayerWeight(0, 0f); //Base Layer
            ...
            else if (angle >= 67.5f && angle < 112.5f) //side right
            {
                animator.SetLayerWeight(0, 0f); //Base Layer
                animator.SetLayerWeight(1, 0f); //Front Layer
                animator.SetLayerWeight(2, 0f); //Front Angle Right Layer
            ...
            else if (angle >= 112.5f && angle < 157.5f) //rear angle right
            {
                animator.SetLayerWeight(0, 0f); //Base Layer
                animator.SetLayerWeight(1, 0f); //Front Layer
                animator.SetLayerWeight(2, 0f); //Front Angle Right Layer
            ...
            else if (angle <= -157.5 || angle >= 157.5f) //rear
            {
                animator.SetLayerWeight(0, 0f); //Base Layer
                animator.SetLayerWeight(1, 0f); //Front Layer
                animator.SetLayerWeight(2, 0f); //Front Angle Right Layer
            ...
            else if (angle >= -157.4f && angle < -112.5f) //rear angle left
            {
                animator.SetLayerWeight(0, 0f); //Base Layer
                animator.SetLayerWeight(1, 0f); //Front Layer
                animator.SetLayerWeight(2, 0f); //Front Angle Right Layer
            ...
            else if (angle >= -112.5f && angle < -67.5f) //side left
            {
                animator.SetLayerWeight(0, 0f); //Base Layer
                animator.SetLayerWeight(1, 0f); //Front Layer
                animator.SetLayerWeight(2, 0f); //Front Angle Right Layer
            ...
            else if (angle >= -67.5f && angle <= -22.5f) //front angle left
            {
                animator.SetLayerWeight(0, 0f); //Base Layer
                animator.SetLayerWeight(1, 0f); //Front Layer
                animator.SetLayerWeight(2, 0f); //Front Angle Right Layer
        ...
        else if (selectedAnimation == "isDyingv1" || selectedAnimation == "isDyingv2")
        {
            animator.SetLayerWeight(0, 0f); //Base Layer
            animator.SetLayerWeight(1, 0f); //Front Layer
            animator.SetLayerWeight(2, 0f); //Front Angle Right Layer
            ...
            animator.SetLayerWeight(7, 0f); //Rear Angle Right layer
            animator.SetLayerWeight(8, 0f); //Rear Angle Left layer
            animator.SetLayerWeight(9, 1f); //Dying
            animator.SetLayerWeight(10, 0f); //Dead
        }
        else if (selectedAnimation == "isDeadCorpse")
        {
            animator.SetLayerWeight(0, 0f); //Base Layer
            animator.SetLayerWeight(1, 0f); //Front Layer
            animator.SetLayerWeight(2, 0f); //Front Angle Right Layer
            ...
            animator.SetLayerWeight(8, 0f); //Rear Angle Left layer
            animator.SetLayerWeight(9, 0f); //Dying
            animator.SetLayerWeight(10, 1f); //Dead
        }
    }
